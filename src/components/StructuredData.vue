...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    description:
      'Join the Madeira Friends community to discover local events, find accommodations, and connect with people in Madeira, Portugal.',
...
const fullUrl = computed(() => {
  if (props.url) {
    return props.url.startsWith('http')
      ? props.url
      : `https://madeirafriends.com${props.url}`
  }
